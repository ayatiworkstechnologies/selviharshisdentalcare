        ...
        <div className="page-container">
          <div className="flex justify-center mb-8">
            <div className="pill-floating inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-4 rounded-full bg-white px-5 sm:px-6 py-3 shadow-soft max-w-full">
              ...
              {/* Book Now opens modal instead of linking to /contact */}
              <button
                type="button"
        ...
        <div className="bg-third">
          <div className="page-container flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-16 py-10 lg:py-14">
            ...
            >
              ...
              <h1 className="title mb-4">Selviharshi&apos;s Dental Care</h1>
              ...
              <div className="flex justify-center lg:justify-start"> <Link href="/about" className="btn btn-md btn-secondary btn-fill"> Know More </Link> </div>
            </div>
          </div>
        </div>
      </section>
